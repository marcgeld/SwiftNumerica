public extension Numerica.Statistics {
    ...
    static func standardDeviation(_ tensor: Tensor<Double>) throws -> Double? {
        try sampleStandardDeviation(tensor)
    }
    ...
    static func populationStandardDeviation(_ tensor: Tensor<Double>) throws -> Double? {
    ...
    /// - Parameter tensor: A sample tensor.
    /// - Returns: The sample standard deviation, or `nil` when fewer than two values are provided.
    static func sampleStandardDeviation(_ tensor: Tensor<Double>) throws -> Double? {
