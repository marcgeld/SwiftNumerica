public extension Numerica.Statistics {
    ...
    static func variance(_ tensor: Tensor<Double>) throws -> Double? {
        try sampleVariance(tensor)
    }
    ...
    static func populationVariance(_ tensor: Tensor<Double>) throws -> Double? {
    ...
    /// - Parameter tensor: A sample tensor.
    /// - Returns: The unbiased sample variance, or `nil` when fewer than two values are provided.
    static func sampleVariance(_ tensor: Tensor<Double>) throws -> Double? {
