public extension Numerica.Statistics {
    ...
    static func sum(_ tensor: Tensor<Double>) throws -> Double? {
    ...
    static func min(_ tensor: Tensor<Double>) throws -> Double? {
    ...
    static func max(_ tensor: Tensor<Double>) throws -> Double? {
    ...
    static func percentile(_ tensor: Tensor<Double>, percentile: Double) throws -> Double? {
    ...
    static func interquartileRange(_ tensor: Tensor<Double>) throws -> Double? {
